...
class MapViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    override func loadView() {
        ...
        let satalliteString = NSLocalizedString("Satellite", comment: "Satellite map view")
        
        let segmentedControl = UISegmentedControl(items: [standardString, hybridString, satalliteString])
